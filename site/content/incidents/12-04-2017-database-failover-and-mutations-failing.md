...
15 minutes later, following normal procedure, a new database instance was added to the cluster and promoted to master. When this happens, the replica that had temporarily acted as master is returned to it's original role as read replica.
